...
# Generates the Gneiss voice guide by stitching gneiss_template.json
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Build the Gneiss voice guide from gneiss_template.json and gneiss_vocabulary.json.")
