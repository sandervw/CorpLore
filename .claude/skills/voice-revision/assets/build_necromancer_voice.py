...
# Generates the Necromancer voice guide by stitching necromancer_template.json
# (fixed structure + sample directives) together with freshly-sampled entries
# from necromancer_vocabulary.json. Run once per session to get a varied voice reference.
#
# Usage:
# - 'python build_necromancer_voice.py' writes the guide to ../references/necromancer-voice.md
# - 'python build_necromancer_voice.py path/to/out.md' writes to the given path instead

HERE = Path(__file__).parent
VOCAB_PATH = HERE / "necromancer_vocabulary.json"
TEMPLATE_PATH = HERE / "necromancer_template.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Build the Necromancer voice guide from necromancer_template.json and necromancer_vocabulary.json.")
