...
I've made a few edits to your suggested outline. Now, let's try to draft it. I think this works best if you function as an orchestrator. Pass the necessary info to an opus-level sub-agent. Instruct it to draft the blobs for the scene we jsut worked on. Make sure it notes the following:
