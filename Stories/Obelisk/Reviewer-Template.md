...
The whole feed is Beau's, posted AFTER THE FACT for an audience. Personal = Beau as himself. Exposition = Beau sharing lore or an artifact in his own voice (not an encyclopedia). Quote/Dialogue = Beau relaying others (often as an overheard scrap or a recovered recording). Action Poem = Beau's dramatized reconstruction. Beau is NEVER a named speaker inside a Dialogue/Quote blob.
...
- **Sterile attributed transcript** with no trace of Beau's curating voice in a Dialogue blob.
- **Flattened voices** (speakers indistinguishable from each other or from Beau), or **re-explained canon** (see Canon below), or **lyrical melancholy stated outright** instead of kept under deadpan.

# BEAU'S VOICE
Vain, wry, self-mythologizing ("Big Beau"), doomed-aristocrat melancholy kept as SUBTEXT via deadpan/self-deprecation/corporate diction. Outsider thief working an angle. Hindsight + dark humor. Addresses followers. When he relays an oration he lets it stand at full height without undercutting it.

# CHARACTER VOICE BIBLE (each quoted speaker must be unmistakably themselves; flattening = FAIL)
{{PASTE_THE_RELEVANT_VOICE_BIBLE_ENTRIES_FOR_SPEAKERS_IN_THIS_SCENE - e.g. Ulakhan: Napoleonic orator, corporate-ladder grandeur, never terse. Gneiss: formal, archaic, oddly tender, glassy. Generic mulchers: flat, corporate, distinct from each other.}}
