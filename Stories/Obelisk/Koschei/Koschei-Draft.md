...
**Next chunk:** The steel doors behind them are struck once from the far side — a blow that shudders up through the brick and shakes dust from the stone roof — and the whole cohort freezes, counting by the blows how little time is left.

**Grounding — Embodiment** (chosen from: Embodiment, Particularity): First blow: Joiyuss's laser hand jumps, red dot skittering wild across the niches.
