...
Narrator, voices, and canon for "The Gatling Laser Axe." The Author writes all prose; this file keeps the shared facts straight for blob-breakdown work and continuity checks. Scene descriptions and breakdowns live in `Story-Outline.md`; the process lives in `Workflow.md`.
...
- **Quote/Dialogue** = Gneiss relaying what others said, often with his spin or a tag. Gneiss is never a named speaker in a Dialogue/Quote blob, and a bare transcript with no Gneiss in it is dead.
